...
while not won:
    ...
    if location == ROOM_START:
        ...
        elif command == "go east" and not key_taken:
            print(KEY_DESC_WITH_KEY)
            location = ROOM_KEY
        elif command == "go east" and key_taken:
            print(KEY_DESC)
            location = ROOM_KEY
        ...
        if command == "go west":
            print(HALL_DESC)
            location = ROOM_HALL
        elif command == "look at key" and not key_taken:
            print(LOOK_KEY)
        elif command == "get key" and not key_taken:
            key_taken = True
            print(KEY_GET)
        else:
            print(SORRY)
